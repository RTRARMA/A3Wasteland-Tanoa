...
_serverInfoString = format ["<t color='#A0FFFF'>=rTr= A3Wasteland Tanoa</t>"];
...
_generalInfoString = "Website: <t color='#0091CD'><a href='http://righttorebel.net/'>righttorebel.net</a></t> Forums: <t color='#0091CD'><a href='http://www.righttorebel.net/forums/forum.php'>=rTr= Forum</a></t> Teamspeak: ts.righttorebel.net";
