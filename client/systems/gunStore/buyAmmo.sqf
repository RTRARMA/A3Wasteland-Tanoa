...
storePurchaseHandle = _this spawn
{
	...
	{
		_itemText = _this select 0;
		hint parseText format ["<t color='#ffff00'>The purchase of this item is only<br/>available to community support members.</t><br/>Learn how to become a community member by visiting the forum at righttorebel.net", _itemText];
		playSound "FD_CP_Not_Clear_F";
		_price = -1;
	};
